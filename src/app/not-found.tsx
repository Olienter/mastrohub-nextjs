    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 dark:bg-slate-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="flex justify-center mb-6">
          <div className="bg-slate-700/50 dark:bg-slate-800 p-3 rounded-full">
            <Search className="h-8 w-8 text-slate-400 dark:text-slate-400" />
          </div>
        </div>
        ...
        <div className="mt-8 text-sm text-slate-400 dark:text-slate-400">
          <p>Error code: 404</p>
        </div>
      </motion.div>
    </div>
