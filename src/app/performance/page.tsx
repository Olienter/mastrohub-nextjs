      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">Performance Data Unavailable</h2>
            <p className="text-slate-300">Failed to load performance metrics</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-slate-800/80 rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-400">Cache Entries</p>
                <p className="text-2xl font-bold text-white">{cache.totalEntries}</p>
              </div>
          ...
          <div className="bg-slate-800/80 rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-400">Slow Queries</p>
                <p className="text-2xl font-bold text-white">
          ...
          <div className="p-6">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Total Hits</span>
                        <span className="font-medium">{cache.totalHits.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Total Misses</span>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Total Queries</span>
                        <span className="font-medium">{queries.length}</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Slow Queries</span>
                ...
                {Object.keys(actionResults).length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">Action Results</h3>
            ...
            {activeTab === 'cache' && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">Top Cache Keys</h3>
                    <div className="space-y-2">
                      {analytics.topKeys.slice(0, 5).map((key, index) => (
                        <div key={key.key} className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                          <div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Small (&lt; 1KB)</span>
                        <span className="font-medium">{analytics.sizeDistribution.small}</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Medium (1-10KB)</span>
                        <span className="font-medium">{analytics.sizeDistribution.medium}</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Large (&gt; 10KB)</span>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-4">Hourly Hit Rate</h3>
                  <div className="grid grid-cols-12 gap-2">
                    {analytics.hitRateByHour.map((rate, hour) => (
                      <div key={hour} className="text-center">
                        <div className="text-xs text-slate-400 mb-1">{hour}:00</div>
                        <div className="h-20 bg-slate-700 rounded relative">
                          <div 
            ...
            {activeTab === 'queries' && (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-semibold text-white">Query Optimizations</h3>
                    ...
                    <div key={index} className="border border-slate-600/50 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className={`px-2 py-1 text-xs rounded-full ${
                          query.improvement > 0 ? 'bg-green-100 text-green-800' : 'bg-slate-700/50 text-slate-200'
                        }`}>
                      ...
                      <div className="space-y-2">
                        <div className="text-sm">
                          ...
                          <code className="ml-2 bg-slate-700/50 px-2 py-1 rounded text-xs">
              ...
              <div className="space-y-6">
                ...
                {recommendations.length === 0 && (
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-lg font-semibold text-white mb-2">All Systems Optimized</h3>
                    <p className="text-slate-300">No performance recommendations at this time.</p>
                  </div>
                )}
              </div>
            )}
