      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">Advanced AI Data Unavailable</h2>
            <p className="text-slate-300 mt-2">Failed to load AI insights and predictions</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-slate-800/80 rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-300">Predicted Sales</p>
          ...
          <div className="bg-slate-800/80 rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-300">Customer Segments</p>
                <p className="text-2xl font-bold text-white">{customerSegmentation.segments.length}</p>
              </div>
            ...
            <div className="mt-2">
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm text-slate-300">High-value focus</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-800/80 rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-300">Menu Optimizations</p>
                <p className="text-2xl font-bold text-white">{menuOptimization.length}</p>
              </div>
          ...
          <div className="bg-slate-800/80 rounded-lg p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-300">Marketing ROI</p>
                <p className="text-2xl font-bold text-white">
          ...
          <div className="p-6">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Key Factors</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">Menu Optimization</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Items Optimized</span>
                        <span className="font-medium">{menuOptimization.length}</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Avg Price Change</span>
                        <span className="font-medium text-green-600">
                          +${(menuOptimization.reduce((sum, m) => sum + (m.recommendedPrice - m.currentPrice), 0) / menuOptimization.length).toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Demand Forecast</span>
                        <span className="font-medium">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">Marketing Campaigns</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                      ...
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Avg ROI</span>
                        <span className="font-medium text-green-600">
                          {(marketingCampaigns.reduce((sum, c) => sum + c.roi, 0) / marketingCampaigns.length).toFixed(1)}x
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-slate-700/50 rounded-lg">
                        <span className="text-sm text-slate-300">Predicted Response</span>
                        <span className="font-medium">
            ...
            {activeTab === 'predictions' && (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-semibold text-white">Sales Predictions (Next 30 Days)</h3>
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {salesPredictions.slice(0, 9).map((prediction, index) => (
                    <div key={index} className="border border-slate-600/50 rounded-lg p-4">
                ...
                <div className="bg-slate-700/50 rounded-lg p-4">
                  <h4 className="font-medium text-white mb-2">Prediction Insights</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div>
                      <span className="text-slate-300">Total Predicted Revenue:</span>
                      ...
                      {customerSegmentation.segments.map((segment, index) => (
                        <div key={index} className="border border-slate-600/50 rounded-lg p-4">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-sm text-slate-300">{segment.customers.length} customers</span>
                          </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {customerBehavior.slice(0, 5).map((customer, index) => (
                        <div key={index} className="border border-slate-600/50 rounded-lg p-4">
                          <div className="flex items-center justify-between mb-2">
                            <span className="font-medium text-white">{customer.customerId}</span>
                            <span className="text-sm text-slate-300">${customer.lifetimeValue.toFixed(0)}</span>
                          </div>
                          <div className="text-sm text-slate-300 mb-2">
            ...
            {activeTab === 'menu' && (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-semibold text-white">Menu Optimization</h3>
                  <button
                  ...
                  {menuOptimization.map((item, index) => (
                    <div key={index} className="border border-slate-600/50 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          <h4 className="font-medium text-white">{item.itemId}</h4>
                          <p className="text-sm text-slate-300">{item.optimizationReason}</p>
                        </div>
                        <div className="text-right">
                          <div className="text-sm text-slate-300">Price Change</div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div>
                          <span className="text-slate-300">Price Elasticity:</span>
                          <span className="font-medium ml-2">{item.priceElasticity.toFixed(2)}</span>
                        </div>
                        <div>
                          <span className="text-slate-300">Demand Forecast:</span>
            ...
            {activeTab === 'marketing' && (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-semibold text-white">AI-Generated Marketing Campaigns</h3>
                  <button
                    ...
                    <div key={index} className="border border-slate-600/50 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-white">{campaign.type.toUpperCase()} Campaign</h4>
                            <p className="text-sm text-slate-300">Target: {campaign.targetAudience.join(', ')}</p>
                          </div>
                        </div>
                        <div className="text-right">
                      ...
                      <div className="mb-3">
                        <div className="text-sm font-medium text-slate-300 mb-1">Message:</div>
                        <p className="text-sm text-slate-200 bg-slate-600/50 p-2 rounded">{campaign.message}</p>
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div>
                          <span className="text-slate-300">Predicted Response:</span>
                        ...
                        <div>
                          <span className="text-slate-300">Expected Revenue:</span>
            ...
            {activeTab === 'inventory' && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">Inventory Recommendations</h3>
                    <div className="space-y-3">
                      {inventoryOptimization.recommendations.map((rec, index) => (
                        <div key={index} className="border border-slate-600/50 rounded-lg p-4">
                          <div className="flex items-center justify-between mb-2">
                            <span className="font-medium text-white">{rec.item}</span>
                            <span className="text-sm text-green-600">+{rec.quantity} units</span>
                          </div>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-4">Reorder Points</h3>
                    <div className="space-y-3">
                      {Object.entries(inventoryOptimization.reorderPoints).map(([item, quantity]) => (
                        <div key={item} className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                          <span className="text-sm font-medium text-white">{item}</span>
                          <span className="text-sm text-slate-300">{quantity} units</span>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="bg-slate-700/50 rounded-lg p-4">
                  <h4 className="font-medium text-white mb-2">Optimization Impact</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div>
                    ...
                    <div>
                      ...
                      <span className="font-medium ml-2">${inventoryOptimization.costSavings.toLocaleString()}</span>
                    </div>
                    <div>
