        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-800/80 border border-slate-600/50 placeholder-slate-400 text-white dark:text-white bg-slate-800/80 dark:bg-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember-me" className="ml-2 block text-sm text-slate-300 dark:text-slate-300">
                Remember me
              </label>
            </div>
